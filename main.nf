...
def helpMessage() {
    ...
    =======================================================
     ...
     nf-core/vipr v${workflow.manifest.version}
    =======================================================
    ...
    or
    nextflow run nf-core/vipr --reads '*_R{1,2}.fastq.gz' --skip_kraken' -profile docker
    ...
    Other options:
      ...
      --skip_kraken                 Don't run Kraken for classification
